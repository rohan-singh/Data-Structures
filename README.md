...
- List ADT
  ...
  - [Single Link (C Implementation)] (https://github.com/rohan-singh/Data-Structures/blob/master/singleList.c).
  - [Double Link (C Implementation)] (https://github.com/rohan-singh/Data-Structures/blob/master/doubleList.c).
- Stack ADT
